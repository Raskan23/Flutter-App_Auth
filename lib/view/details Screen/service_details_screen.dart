...
import 'package:MahiGo_Fix/view/details%20Screen/pickup_date.dart';
import 'package:MahiGo_Fix/view/details%20Screen/pickup_model.dart';
import 'package:MahiGo_Fix/view/details%20Screen/pickup_time.dart';
...
class _ServiceDetailsScreenState extends State<ServiceDetailsScreen> {
  ...
  Widget selectTime (){
    return SizedBox(
      ...
      child: ListView.separated(
          physics: const BouncingScrollPhysics(),
          padding: EdgeInsets.only(left: 20.h,top: 13.h),
          scrollDirection: Axis.horizontal,
          itemBuilder: (context, index) => GestureDetector(
            onTap: () {
              setState(() {
